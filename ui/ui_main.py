...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(645, 289)
        icon = QIcon()
        icon.addFile(u":/icons/icons/vpn_key_black_24dp.ico", QSize(), QIcon.Normal, QIcon.On)
...
"}")
        ...
        self.layout_info.addWidget(self.logo, 0, Qt.AlignLeft)
...
"}")
        ...
        self.btn_copy.setIconSize(QSize(38, 38))
